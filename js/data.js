window.WEDDING_DATA = {
  ...
  copy: {
    invitation: [
      "오늘도, 내일도 함께하고 싶은 사람이 생겼습니다.",
      "서로의 하루를 아끼며 같은 방향을 바라보고<br>평생을 함께 걸어가려 합니다.",
      "저희 결혼식은 양가 가족과 함께하는 작은 자리로<br>조용히 치르려 합니다.",
      "멀리서도 저희의 결혼 소식을 기쁘게 기억해 주시고<br>따뜻한 마음으로 축복해 주시면 감사하겠습니다."
    ],
    outro: "저희의 결혼 소식을 따뜻한 마음으로 축복해 주셔서 감사합니다.<br>보내주신 마음 오래도록 간직하며 행복하게 잘 살겠습니다."
  },
